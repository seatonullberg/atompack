...
def bench_crystal(lattice_data, lattice_sites, a, b, c, alpha, beta, gamma, duplicates, orientation, pbc, tolerance):
    return Crystal(lattice_data,
                   lattice_sites,
                   a,
                   b,
                   c,
...
def test_bench_crystal_Fe_BCC_100_1x1x1(benchmark):
    lattice_data = [{"symbol": "Fe"}, {"symbol": "Fe"}]
    ...
    tolerance = 1e-6
    args = (lattice_data, lattice_sites, a, b, c, alpha, beta, gamma, duplicates, orientation, pbc, tolerance)
