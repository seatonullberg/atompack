...
def test_crystal_cubic_100_super_cell():
    ...
    lattice_data = [{"symbol": "Fe"}, {"symbol": "Fe"}]
    lattice_sites = np.array([[0, 0, 0], [0.5, 0.5, 0.5]])
    crystal = Crystal(lattice_data, lattice_sites, a, b, c, alpha, beta, gamma, duplicates=duplicates)
...
def test_crystal_cubic_110_unit_cell():
    ...
    crystal = Crystal(lattice_data, lattice_sites, a, b, c, alpha, beta, gamma, orientation=orientation)
